...
# 1. As illustrated, our method can directly reuse the parameters from the original Attention
# module, and simply introduces a motion_conv module to equip it with motion modeling capability.
# 2. However, if you would like to replace your original Attention module with our EMIM module,
# it is recommended to perform zero initialization at the beginning to maintain parameter stability
# — a useful tip for parameter-efficient fine-tuning. When training from scratch, this initialization
# can be omitted.
...
journal={Pattern Recognition}, pages={112645},
year={2025}, publisher={Elsevier} }
```

# Contact:
Please feel free to contact zpq0316@163.com, if you have any questions about EMIM.
