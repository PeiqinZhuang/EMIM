...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer"]
...
_C.UNIFORMER.ATTENTION_DROPOUT_RATE = 0.0
...
# costvolume attention
_C.UNIFORMER.EXTRA_BLOCK = ''
_C.UNIFORMER.EXTRA_BLOCK_IDX = [-1, -1, -1]
_C.UNIFORMER.EXTRA_BLOCK_DEPTH = 1
_C.UNIFORMER.EXTRA_ATTN_TYPE = 'extra_attn1'
_C.UNIFORMER.EXTRA_TEMPORAL_ATTN = ''
_C.UNIFORMER.EXTRA_MAX_DISP = [7, 7, 7]


_C.UNIFORMER.ATTN_TYPE = [None, None]
_C.UNIFORMER.TEMPORAL_ATTN = ''
_C.UNIFORMER.ATTN_DROP_PATH = False
_C.UNIFORMER.ATTN_MAX_DISP = [7, 7]
_C.UNIFORMER.CONSENSUS = False
_C.UNIFORMER.CONTINUOUS_ATTN = 'gg'
_C.UNIFORMER.LAYER_SCALE = False
_C.UNIFORMER.SPECIAL_INIT = False

_C.UNIFORMER.LAYERNORM_INITIALIZATION = False
_C.UNIFORMER.EXTRA_BEFORE = True
