...
GLOG_vmodule=MemcachedClient=-1 srun -p ${GPU_TYPE} --mpi=pmi2 \
  ...
  python tools/run_net.py \
    ...
    DATA.PATH_PREFIX PATH_PREFIX/ssv2_video/ \
    ...
    TEST.CHECKPOINT_FILE_PATH ./exp/uniformer_s16_sthv2_prek400_uniformer_extra_attn64_ATTN_ATTN_7_7_LG/checkpoints/checkpoint_best.pyth \
    RNG_SEED 6666 \
